# Contributing, branch management, and code style

I'll be glad to accept any contribution, be it documentation,
implementation coverage, bug fixes, or new features.

See the [open issues](https://codeberg.org/aartaka/(#| TMPL_VAR name |#)/issues)
